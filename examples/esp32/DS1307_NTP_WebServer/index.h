...
.DataCard{
  ...
  <form action="/" method="POST">
    <div class="slidecontainer">
   <button onclick="myFunctionN()" class="button-blue" style="width:48%">NTP Time</button>
   <button onclick="myFunctionS()" class="button-blue" style="width:48%">Save Time</button>
   </div>
  </form></td>
  </table>
  </div></div>
